                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            ...
                            include "koneksi.php";
                            $id = $_GET['id'];
                            $query_mysql = mysqli_query($koneksi,"SELECT * FROM kategori_buku WHERE id='$id'");
                            while($data = mysqli_fetch_array($query_mysql)){
                            ?>
                            <form action="proseseditkategoribuku.php" method="post">
                                <input type="hidden" name="id" value="<?=$data['id']?>">
                                <div class="from-group" >
                                    <label>Nama Kategori Buku</label>
                                <input type="text" name="kat_buku" value="<?=$data['kat_buku'] ?>" class="form-control"/>
                                </div> 
                                <!-- <div class="from-group" >
                                    <label>Denda</label>
