...
use PhpOffice\PhpSpreadsheet\Writer\Xlsx;
    ...
    foreach($sql as $d) {
                            ...
                            $spreadsheet->setActiveSheetIndex(0)
                                        ...
                                        ->setCellValue('F' . $kolom, date('d F Y',strtotime($d['tgl_dikembalikan'])))
                                        ->setCellValue('G' . $kolom, $stat);
    ...
    header('Content-Disposition: attachment;filename="Laporan_Pengembalian'.date('Y-m-d hh:mm:ss').'".xlsx"');
